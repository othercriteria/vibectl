...
def test_cluster_info_basic(
    ...
    # Setup
    mock_run_kubectl.return_value = "Kubernetes control plane is running at https://example:6443"
...
def test_cluster_info_vibe_request(mock_handle_vibe_request: Mock, cli_runner: CliRunner) -> None:
    """Test cluster-info command with vibe request."""
    # Execute
    result = cli_runner.invoke(cluster_info, ["vibe", "show", "me", "cluster", "health"])
...
def test_cluster_info_vibe_no_request(cli_runner: CliRunner, mock_console: Mock) -> None:
