...
docker exec -it $container_name vibectl vibe "How can I optimize my Kubernetes deployments?"
docker exec -it $container_name vibectl vibe "Show me pods with high restarts"
echo
...
docker exec -it $container_name vibectl memory show
docker exec -it $container_name vibectl vibe
docker exec -it $container_name vibectl memory show
echo
