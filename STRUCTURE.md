...
- `kafka-throughput-demo/` - Demonstrates vibectl tuning Kafka performance under synthetic load. See [examples/kafka-throughput-demo/STRUCTURE.md](examples/kafka-throughput-demo/STRUCTURE.md) for details.
